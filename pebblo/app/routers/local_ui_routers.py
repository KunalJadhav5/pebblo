...
local_ui_router_instance.router.add_api_route("/", App.dashboard, methods=["POST"],  response_class=HTMLResponse)
local_ui_router_instance.router.add_api_route("/appDetails", App.appDetails, methods=["POST"],  response_class=HTMLResponse)
